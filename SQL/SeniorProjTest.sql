...
insert into advisor values('Sanethia Thomas', aIDSeq.nextval, 's@ufl.edu');
...
insert into project values('cool stuff', 11, 3, 5, 3, 'THis is a cool project blah blah', null, 'jame@ufl.edu');
insert into project values('bad stuff', 13, 3, 3, 2, 'Cheese is a cool project blah blah', null, 'jon@ufl.edu');
insert into project values('okay stuff', 0, 3, 4, 3, 'Jonathan is a cool project blah blah', null, 'joe@ufl.edu');
insert into project values('whoaaa stuff', 89, 3, 2, 1, 'TImmy turner is a cool project blah blah', null, 'jim@ufl.edu');
insert into project(NAME , PID , CID , CAPACITY , FILLED , DESCINPUT , PASS, CONTACT) values('some stuff', 12, 3, 5, 3, 'MOOOOOOOOOOOOOOOOOO Cow ', null, 'jerome@ufl.edu');
insert into project(NAME , PID , CID , CAPACITY , FILLED , DESCINPUT , PASS, CONTACT) values('more stuff', 14, 55555555, 5, 3, 'ahhhhhhhhh', null, 'jerold@ufl.edu');
